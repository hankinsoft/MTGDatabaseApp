...
@property(nonatomic,assign) xmlNodePtr xmlNode_; // may also be an xmlAttrPtr or xmlNsPtr
...
- (NSString *) XMLStringFormatted
{
    ...
    if (self.xmlNode_ != NULL)
    {
        ...
        if (buff)
        {
            ...
            int result = xmlNodeDump(buff, doc, self.xmlNode_, level, format);
...
- (id)initWithXMLString:(NSString *)str error:(NSError **)error {
  ...
  if (self) {
    ...
    if (doc == NULL) {
      ...
      if (root) {
        self.xmlNode_ = xmlCopyNode(root, 1); // 1: recursive
      }
      xmlFreeDoc(doc);
    }
...
- (NSArray *)namespaces {
  ...
  if (self.xmlNode_ != NULL && self.xmlNode_->nsDef != NULL) {

    xmlNsPtr currNS = self.xmlNode_->nsDef;
    while (currNS != NULL) {
...
- (void)setNamespaces:(NSArray *)namespaces {
  ...
  if (self.xmlNode_ != NULL) {
    ...
    if (self.xmlNode_->nsDef) {
      xmlFreeNsList(self.xmlNode_->nsDef);
      self.xmlNode_->nsDef = NULL;
    }
    ...
    while ((namespace = [enumerator nextObject]) != nil) {
      ...
      if (ns) {
        (void)xmlNewNs(self.xmlNode_, ns->href, ns->prefix);
      }
    }
    ...
    [[self class] fixUpNamespacesForNode:self.xmlNode_
                      graftingToTreeNode:self.xmlNode_];
  }
}
...
- (void)addChild:(GDataXMLNode *)child {
  ...
  if (self.xmlNode_ != NULL) {
    ...
    if (childNodeCopy) {
      ...
      xmlNodePtr resultNode = xmlAddChild(self.xmlNode_, childNodeCopy);
      if (resultNode == NULL) {
...
- (NSArray *)elementsForName:(NSString *)name {
  ...
  if (self.xmlNode_ != NULL) {
    ...
    if (prefix) {
      ...
      xmlNsPtr foundNS = xmlSearchNs(self.xmlNode_->doc, self.xmlNode_, desiredPrefix);
      if (foundNS) {
...
- (NSArray *)elementsForLocalName:(NSString *)localName URI:(NSString *)URI {
  ...
  if (self.xmlNode_ != NULL && self.xmlNode_->children != NULL) {
    ...
    xmlNsPtr foundParentNS = xmlSearchNsByHref(self.xmlNode_->doc, self.xmlNode_, desiredNSHref);
    ...
    for (GDataXMLNode *child in children) {
      ...
      if (currChildPtr->type == XML_ELEMENT_NODE) {
        ...
        if (currChildPtr->nsDef != NULL) {
          ...
          childLocalNS = xmlSearchNsByHref(self.xmlNode_->doc, currChildPtr, desiredNSHref);
...
- (NSArray *)attributes {
  ...
  if (self.xmlNode_ != NULL && self.xmlNode_->properties != NULL) {

    xmlAttrPtr prop = self.xmlNode_->properties;
    while (prop != NULL) {
...
- (void)addAttribute:(GDataXMLNode *)attribute {
  ...
  if (self.xmlNode_ != NULL) {
    ...
    if (attrPtr) {
      ...
      if (attrPtr->ns == NULL) {
        oldAttr = xmlHasProp(self.xmlNode_, attrPtr->name);
      } else {
        oldAttr = xmlHasNsProp(self.xmlNode_, attrPtr->name, attrPtr->ns->href);
      }
      ...
      if (oldAttr == NULL) {
        ...
        if (attrPtr->ns != NULL) {
          ...
          newPropNS = xmlSearchNsByHref(self.xmlNode_->doc, self.xmlNode_, attrPtr->ns->href);
          if (newPropNS == NULL) {
            // make a new namespace on the parent node, and use that for the
            // new attribute
            newPropNS = xmlNewNs(self.xmlNode_, attrPtr->ns->href, attrPtr->ns->prefix);
          }
        }

        // copy the attribute onto this node
        xmlChar *value = xmlNodeGetContent((xmlNodePtr) attrPtr);
        xmlAttrPtr newProp = xmlNewNsProp(self.xmlNode_, newPropNS, attrPtr->name, value);
        if (newProp != NULL) {
...
- (GDataXMLNode *)attributeForName:(NSString *)name {
  ...
  if (self.xmlNode_ != NULL) {
    ...
    xmlAttrPtr attrPtr = xmlHasProp(self.xmlNode_, GDataGetXMLString(name));
    if (attrPtr == NULL) {
      ...
      if (prefix) {
        ...
        ns = xmlSearchNs(self.xmlNode_->doc, self.xmlNode_, GDataGetXMLString(prefix));
      }

      const xmlChar* nsURI = ((ns != NULL) ? ns->href : NULL);
      attrPtr = xmlHasNsProp(self.xmlNode_, GDataGetXMLString(name), nsURI);
    }
...
- (GDataXMLNode *)attributeForLocalName:(NSString *)localName
  ...
  if (self.xmlNode_ != NULL) {
    ...
    xmlAttrPtr attrPtr = xmlHasNsProp(self.xmlNode_, name, nsURI);
    ...
    if (attrPtr == NULL) {
      ...
      attrPtr = xmlHasProp(self.xmlNode_, xmlFakeQName);
    }
...
- (NSString *)resolvePrefixForNamespaceURI:(NSString *)namespaceURI {
  ...
  if (self.xmlNode_ != NULL) {
    ...
    xmlNsPtr foundNS = xmlSearchNsByHref(self.xmlNode_->doc, self.xmlNode_, desiredNSHref);
    if (foundNS) {
